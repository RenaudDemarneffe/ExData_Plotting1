...
##
## This script will compute the plot4 asked in the instructions
## file.
##
###################################################################
##
...
##  3. Build the graphic with 4 sub-graphs.
##
###################################################################
...
# Close the device.
dev.off()
message("\"plot4.png\" file generated.")