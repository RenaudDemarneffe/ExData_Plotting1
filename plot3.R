...
##
## This script will compute the plot3 asked in the instructions
## file.
##
###################################################################
##
...
##  3. Build the graphic Energy sub metering vs day-time for each 
...
# Close the device.
dev.off()
message("\"plot3.png\" file generated.")