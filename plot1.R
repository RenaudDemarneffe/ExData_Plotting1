...
##
## This script will compute the plot1 asked in the instructions
## file.
##
###################################################################
##
...
##  3. Build the histogram Frequency (count) vs Global Active Power
##     (kilowatts).
##
###################################################################
...
# Build the plot.
hist(hhpc$Global_active_power, main = "Global Active Power", col = "red",
     xlab = "Global Active Power (kilowatts)", ylab = "Frequency")

# Close the device.
dev.off()
message("\"plot1.png\" file generated.")
